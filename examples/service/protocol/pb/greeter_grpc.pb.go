...
import (
	...
	grpc1 "github.com/oslet/erda-infra/pkg/transport/grpc"
...
func (c *greeterServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.infra.example.GreeterService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _GreeterService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.infra.example.GreeterService",
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.infra.example.GreeterService/SayHello",
				}
