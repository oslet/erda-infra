...
// EncodeData .
func (d *DefaultComplexGraph) EncodeData(srcStructPtr interface{}, dstRawPtr *cptype.ComponentData) {
	if custom, ok := d.Impl.(complexgraph.CustomData); ok {
		custom.EncodeFromCustomData(custom.CustomDataPtr(), srcStructPtr.(*complexgraph.Data))
	}
	cputil.MustObjJSONTransfer(srcStructPtr, dstRawPtr)
}

// EncodeState .
func (d *DefaultComplexGraph) EncodeState(srcStructPtr interface{}, dstRawPtr *cptype.ComponentState) {
...
// EncodeInParams .
func (d *DefaultComplexGraph) EncodeInParams(srcStructPtr interface{}, dstRawPtr *cptype.InParams) {
	if custom, ok := d.Impl.(complexgraph.CustomState); ok {
		custom.EncodeFromCustomState(custom.CustomStatePtr(), srcStructPtr.(*cptype.ExtraMap))
	}
	cputil.MustObjJSONTransfer(srcStructPtr, dstRawPtr)
