...
// DecodeData .
func (d *DefaultKanban) DecodeData(compData cptype.ComponentData, modelDataPtr interface{}) {
	cputil.MustObjJSONTransfer(compData, modelDataPtr.(*kanban.Data))
...
// DecodeState .
func (d *DefaultKanban) DecodeState(compState cptype.ComponentState, modelStatePtr interface{}) {
...
// DecodeInParams .
func (d *DefaultKanban) DecodeInParams(compInParams cptype.InParams, modelInParamsPtr interface{}) {
