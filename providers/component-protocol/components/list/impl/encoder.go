...
import (
	"github.com/oslet/erda-infra/providers/component-protocol/components/list"
...
// EncodeData .
func (d *DefaultList) EncodeData(srcStructPtr interface{}, dstRawPtr *cptype.ComponentData) {
	// custom -> struct
	if custom, ok := d.Impl.(list.CustomData); ok {
		custom.EncodeFromCustomData(custom.CustomDataPtr(), srcStructPtr.(*list.Data))
	}
	// struct -> raw
...
// EncodeState .
func (d *DefaultList) EncodeState(srcStructPtr interface{}, dstRawPtr *cptype.ComponentState) {
...
// EncodeInParams .
func (d *DefaultList) EncodeInParams(srcStructPtr interface{}, dstRawPtr *cptype.InParams) {
